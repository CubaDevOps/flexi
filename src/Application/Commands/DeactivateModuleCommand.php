...
/**
 * Command DTO for deactivating a module.
 *
 * Represents the parameters needed to deactivate a specific module.
 */
class DeactivateModuleCommand implements DTOInterface
{
